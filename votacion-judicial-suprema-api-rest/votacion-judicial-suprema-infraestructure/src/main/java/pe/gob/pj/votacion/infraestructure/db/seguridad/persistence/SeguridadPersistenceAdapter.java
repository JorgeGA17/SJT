package pe.gob.pj.votacion.infraestructure.db.seguridad.persistence;
...
import pe.gob.pj.votacion.domain.model.seguridad.Rol;
import pe.gob.pj.votacion.domain.model.seguridad.Usuario;
...
import pe.gob.pj.votacion.domain.port.persistence.seguridad.SeguridadPersistencePort;
import pe.gob.pj.votacion.infraestructure.common.utils.EncryptUtils;
import pe.gob.pj.votacion.infraestructure.db.seguridad.entities.MaeOperacionEntity;
import pe.gob.pj.votacion.infraestructure.db.seguridad.repositories.MaeRolRepository;
import pe.gob.pj.votacion.infraestructure.db.seguridad.repositories.MaeRolUsuarioRepository;
import pe.gob.pj.votacion.infraestructure.db.seguridad.repositories.MaeUsuarioRepository;
...
public class SeguridadPersistenceAdapter implements SeguridadPersistencePort {
  ...
  public Optional<String> validarAccesoMetodo(String cuo, AutorizacionPeticionQuery query) {
    return maeRolUsuarioRepository.obtenerAccesoMetodos(query.usuario(), query.rol()).stream()
        ...
        .filter(op -> op.getMaeTiposOperacion()==null || query.tipoOperacion()
