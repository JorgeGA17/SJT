package pe.gob.pj.votacion.infraestructure.common.utils;
...
public class PatronValidacionConstants {
  ...
  public static final String FECHA_MM_DD_YYYY_HH_MM_SS_SSS = "([0][1-9]|[1][0-2])-([0][1-9]|[1-2][0-9]|[3][0-1])-(\\d{4}) (\\d{2}):(\\d{2}):(\\d{2})\\.(\\d{3})";
  ...
  public static final String FECHA_YYYY_MM_DD = "(\\d{4})-(\\d{2})-(\\d{2})";
  public static final String FECHA_DD_MM_YYYY = "(\\d{2})/(\\d{2})/(\\d{4})";
  public static final String TIPO_REPORTE = "(?i)^(excel)$";
