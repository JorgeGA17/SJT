package pe.gob.pj.votacion.infraestructure.security.filters;
...
import pe.gob.pj.votacion.domain.exceptions.general.DominiosClientesNoPermitidosException;
import pe.gob.pj.votacion.domain.exceptions.general.ParametrosConsumoNoDesencriptadosException;
import pe.gob.pj.votacion.domain.model.seguridad.RoleSecurity;
import pe.gob.pj.votacion.domain.model.seguridad.query.AutenticacionUsuarioQuery;
import pe.gob.pj.votacion.domain.port.usecase.seguridad.AutenticarClienteUseCasePort;
import pe.gob.pj.votacion.infraestructure.common.enums.HttpCabeceraInfo;
import pe.gob.pj.votacion.infraestructure.common.enums.JwtPropiedades;
import pe.gob.pj.votacion.infraestructure.common.utils.EncryptUtils;
import pe.gob.pj.votacion.infraestructure.common.utils.InfraestructureConstant;
import pe.gob.pj.votacion.infraestructure.properties.SeguridadProperty;
import pe.gob.pj.votacion.infraestructure.security.adapters.CustomUserDetails;
