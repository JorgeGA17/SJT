...
import pe.gob.pj.votacion.domain.model.AplicativoToken;
...
import pe.gob.pj.votacion.infraestructure.rest.responses.AplicativoResponse;
import pe.gob.pj.votacion.infraestructure.rest.responses.RefrescarTokenResponse;
  ...
  public ResponseEntity<RefrescarTokenResponse> refreshToken(PeticionServicios peticion,
    ...
    try {
      ...
      if (ahora.after(limiteRefresh)) {
        ...
        throw new TiempoActualizarTokenExcedidoException();
      }
