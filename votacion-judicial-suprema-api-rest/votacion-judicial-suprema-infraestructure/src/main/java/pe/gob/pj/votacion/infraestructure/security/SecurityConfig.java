package pe.gob.pj.votacion.infraestructure.security;
...
import pe.gob.pj.votacion.domain.port.usecase.seguridad.ObtenerInfoClienteUseCasePort;
...
import pe.gob.pj.votacion.infraestructure.security.adapters.UserDetailsServiceAdapter;
import pe.gob.pj.votacion.infraestructure.security.filters.AuditValidationFilter;
import pe.gob.pj.votacion.infraestructure.security.filters.JwtAuthorizationFilter;
import pe.gob.pj.votacion.infraestructure.security.filters.JwtLoginAuthenticationFilter;
import pe.gob.pj.votacion.usecase.seguridad.ValidarAutorizacionUseCaseAdapter;
...
public class SecurityConfig {
  ...
  SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    http.headers(
        headers -> headers.frameOptions(FrameOptionsConfig::deny).httpStrictTransportSecurity(
