...
@EnableJpaRepositories(
    basePackages = "pe.gob.pj.votacion.infraestructure.db.auditoriageneral.repositories",
...
public class AuditoriaGeneralConfig {
  ...
  DataSource auditoriaDataSource() throws NamingException {
    return (DataSource) new InitialContext()
        .lookup("java:jboss/datasources/votacionJudicialSupremaAPIAuditoriaGeneral");
  }
  ...
  LocalContainerEntityManagerFactoryBean auditoriaEntityManagerFactory(
    ...
    return builder.dataSource(dataSource)
        .packages("pe.gob.pj.votacion.infraestructure.db.auditoriageneral.entities")
