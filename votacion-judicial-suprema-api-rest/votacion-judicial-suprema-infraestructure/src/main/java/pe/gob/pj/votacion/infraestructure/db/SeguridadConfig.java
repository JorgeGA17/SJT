...
@EnableJpaRepositories(
    basePackages = "pe.gob.pj.votacion.infraestructure.db.seguridad.repositories",
...
public class SeguridadConfig {
  ...
  DataSource seguridadDataSource() throws NamingException {
    return (DataSource) new InitialContext()
        .lookup("java:jboss/datasources/votacionJudicialSupremaAPISeguridad");
  }
  ...
  LocalContainerEntityManagerFactoryBean seguridadEntityManagerFactory(
    ...
    return builder.dataSource(dataSource)
        .packages("pe.gob.pj.votacion.infraestructure.db.seguridad.entities")
        .persistenceUnit("seguridad").properties(getHibernateProperties()).jta(true).build();
  }
